...
void Engine::ImGUIVK::InitImGUI(ImGUIVKInfo info)
{
    ...
    init_info.PipelineRenderingCreateInfo.pColorAttachmentFormats = &info.ImageFormat;
    ...
    info.DeletionQueue->PushFunction([=]()
    {
        ImGui_ImplVulkan_Shutdown();
        vkDestroyDescriptorPool(info.Device, imguiPool, nullptr);
    });
