...
namespace FastReflection.CodeGen
{
    ...
    {
        public void GenerateReflectionCode(List<SourceFile> classes, string outputDir)
        {
            foreach (var reflectedClass in classes)
            {
                GenerateHeaderFile(reflectedClass, outputDir, reflectedClass.path);
                GenerateSourceFile(reflectedClass, outputDir, reflectedClass.path);
            }
        }
        ...
        public void GenerateHeaderFile(SourceFile classesInFile, string outputDir, string sourceFile = "")
        {
            ...
            foreach (var reflectedClass in classesInFile.classes)
            {
                ...
                sb.AppendLine(
                    $"// Reflection data for: {reflectedClass.Name} in namespace: {reflectedClass.Namespace}");
        ...
        public void GenerateSourceFile(SourceFile classesInFile, string outputDir, string sourceFile = "")
        {
            var sb = new StringBuilder();
            foreach (var reflectedClass in classesInFile.classes)
            {
